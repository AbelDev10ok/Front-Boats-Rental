...
import { fetchUpdateMarin } from "../services/dataMarins";
import useStore from "../store/useStore";
import Marin from "../types/Marin";

export default function useMarinCrud(){
    ...
    //         alert("No se pudo borrar el marins: " + error )
    ...
    return {marins,setMarins,updateMarin,editingId,startEditing}
}