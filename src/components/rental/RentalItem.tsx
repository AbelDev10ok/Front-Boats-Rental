    ...
    <div className="h-min bg-white shadow-md rounded-lg overflow-hidden">
      {isEditing ? (
        ...
        <div className="p-4">
          ...
          <p className="text-gray-600 mb-1">Fecha Inicio: {rental.dateInit ? rental.dateInit.toString() : ''}</p>
          <p className="text-gray-600 mb-1">Fecha Fin: {rental.dateEnd ? rental.dateEnd.toString() : ''}</p>
